...
async function main() {
  ...
  switch (parsed.command) {
    case "init":
      await runInit({ json: !!opts.json, rootPath: opts.rootPath, profile: opts.profile, forceConfig: !!opts.forceConfig, forceRootConfig: !!opts.forceRootConfig, strictDoctor: !!opts.strictDoctor });
      return;
    case "diff":

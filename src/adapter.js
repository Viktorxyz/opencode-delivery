 ...
 * package. The loader reads, validates, and produces a SHA lock for
 * the adapter version.
 */
...
const KNOWN_FORGE_KEYS = new Set([
  "driver",
  "issueRequired",
...
const KNOWN_VERIFICATION_KEYS = new Set([
  "commands",
...
export function validateAdapter(value) {
  ...
  if (obj.repository !== undefined) {
    ...
    if (r.defaultBranch !== undefined) {
      ...
      if (db.discover !== undefined && typeof db.discover !== "boolean")
  ...
  if (obj.forge !== undefined) {
    ...
    if (f.driver !== undefined && f.driver !== "github")
      issues.push("forge.driver must be 'github'");
    if (f.issueRequired !== undefined && typeof f.issueRequired !== "boolean")
      issues.push("forge.issueRequired must be boolean");
    if (f.draftAfterFirstCommit !== undefined && typeof f.draftAfterFirstCommit !== "boolean")
      issues.push("forge.draftAfterFirstCommit must be boolean");
    if (f.issueClosingSyntax !== undefined && typeof f.issueClosingSyntax !== "boolean")
  ...
  if (obj.worktree !== undefined) {
    ...
    if (w.root !== undefined && typeof w.root !== "string")
      issues.push("worktree.root must be string");
    if (w.branchTemplate !== undefined && typeof w.branchTemplate !== "string")
      issues.push("worktree.branchTemplate must be string");
    if (w.bootstrap !== undefined && !isStringArrayOfArrays(w.bootstrap))
    ...
    if (v.commands !== undefined) {
      if (!Array.isArray(v.commands)) issues.push("verification.commands must be an array");
        ...
        for (let i = 0; i < v.commands.length; i++) {
          ...
          if (cmd.timeoutMs !== undefined && typeof cmd.timeoutMs !== "number")
            issues.push(`verification.commands[${i}].timeoutMs must be number`);
        }
      }
    }
    if (v.requireCleanDiffAfter !== undefined && typeof v.requireCleanDiffAfter !== "boolean")
      issues.push("verification.requireCleanDiffAfter must be boolean");
    if (
      v.invalidateOnHeadChange !== undefined &&
      typeof v.invalidateOnHeadChange !== "boolean"
    )
  ...
  if (obj.review !== undefined) {
    ...
    if (r.invalidateOnHeadChange !== undefined && typeof r.invalidateOnHeadChange !== "boolean")
  ...
  if (obj.ci !== undefined) {
    ...
    if (c.driver !== undefined && c.driver !== "github-status-checks")
      issues.push("ci.driver must be 'github-status-checks'");
    if (c.requiredChecks !== undefined && !isStringArray(c.requiredChecks))
      issues.push("ci.requiredChecks must be string[]");
    if (c.wait !== undefined && typeof c.wait !== "boolean")
      issues.push("ci.wait must be boolean");
    if (c.flakyRetry !== undefined && c.flakyRetry !== 0 && c.flakyRetry !== 1)
  ...
  if (obj.ready !== undefined) {
    ...
    if (r.stopAfterReady !== undefined && typeof r.stopAfterReady !== "boolean")
  ...
  if (obj.merge !== undefined) {
    ...
    if (m.strategy !== undefined && m.strategy !== "squash")
      issues.push("merge.strategy must be 'squash'");
    if (m.policy !== undefined && m.policy !== "explicit-user-request-only")
      issues.push("merge.policy must be 'explicit-user-request-only'");
    if (m.requireFreshGates !== undefined && typeof m.requireFreshGates !== "boolean")
  ...
  if (obj.cleanup !== undefined) {
    ...
    if (c.when !== undefined && c.when !== "next-task")
...
/**
 * Maintenance helper. Plugin startup is read-only and MUST NOT call
 * this directly; only an explicit maintenance command (or CI workflow)
 * may rewrite the lockfile.
 */
